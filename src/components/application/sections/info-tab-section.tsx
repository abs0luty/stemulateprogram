  ...
  <TabsContent value="info" className="space-y-6">
    <div className="space-y-2">
      <div className="space-y-6">
        <div>
          <h2 className="text-3xl font-semibold mb-6 mt-6">Program Overview:</h2>
          <p>
            ...
            structured, how academic arguments are developed, and how evidence
        ...
        <div>
          <p>
            The primary goal of the program is to equip students with a strong
            foundation in academic thinking and research practices, preparing
            them for future academic projects, competitions, and
        ...
        <div className="pt-6">
          ...
          <p>
            <i>
              Limited discounts may also be available for the most competitive
    ...
    <SectionNavigation nextLabel="Start Application" onNext={onStart} />
  </TabsContent>
)
